<?php
  $t_ticketSelect = "select * from t_like left join t_ticket on t_like.f_ticketNo = t_ticket.f_ticketNo where t_like.f_userNo = {$userNo} order by t_like.f_date desc;";
